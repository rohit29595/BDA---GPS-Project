...
def get_value():
    ...
    for filename in filename_list:
        ...
        time_dict[filename] = trip_time

    min_time = min(time_dict, key = time_dict.get)
    print("The file " + str(min_time) + " had a minimum time of " + str(time_dict[min_time]))

    min_cost = min(cost_function_dict, key = cost_function_dict.get)
    print("The file " + str(min_cost) + " had a minimum cost function of " + str(cost_function_dict[min_cost]))

    return min_time

def main():
    print("Computing the file with the minimum cost function \n")
